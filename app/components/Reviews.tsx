...
export const projects = [
    {
        ...
        text:
            "Процесс по созданию моего сайта-портфолио прошло на высшем уровне. Денис внимательно выслушал все мои пожелания и сразу приступил к работе, быстро уловив мой стиль и идеи. Денис также помог подобрать современный и привлекательный дизайн, который отлично отражает мои работы. Я очень довольна результатом и уже получила множество положительных отзывов от клиентов!",
    },
    {
        title: "Виталий",
        subtitle: {
